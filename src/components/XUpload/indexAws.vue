  ...
  <div :class="['upload-container', imgSize, backfillList.length > 3 ? 'many' : '']">
    ...
    <div class="upload-btn" :style="{display: (String(backfillList) !== '' && limit === 1) ? 'none' : 'inline-block'}">
      <el-upload
        ...
        <i class="el-icon-plus avatar-uploader-icon" @click="changePlus"/>
        <span>{{ fileLabel }}</span>
      </el-upload>
    </div>
  </div>
...
.upload-container.size201 {
  .upload-view .view-item { width: 133px; height: 201px; }
  /deep/ .upload-btn .el-upload.el-upload--picture-card {
    width: 133px; height: 201px;
  ...
  /deep/ .upload-btn i.el-icon-plus{
    width:56px;
    height:56px;
    line-height: 56px;
    background: #000;
...
.upload-container.size173 {
  .upload-view .view-item { width: 173px; height: 173px; }
  /deep/ .upload-btn .el-upload.el-upload--picture-card {
    width: 173px; height: 173px; line-height: 158px;background-color: #1D1D1F!important;
    border: 1px solid #1D1D1F!important;
    border-radius: 12px;
  }
  /deep/ .upload-btn i.el-icon-plus { font-size: 36px;color:#fff!important; }
}
/* 1. -152版 */
.upload-container.size152 {
  .upload-view .view-item { width: 152px; height: 152px; }
  /deep/ .upload-btn .el-upload.el-upload--picture-card {
    width: 152px; height: 152px; line-height: 158px;background-color: #1D1D1F!important;
    border: 1px solid #1D1D1F!important;
  }
  /deep/ .upload-btn i.el-icon-plus { font-size: 36px;color:#fff!important; }
}
.upload-container.size56 {
  .upload-view .view-item { width:56px; height:56px; }
  /deep/ .upload-btn .el-upload.el-upload--picture-card { background-color: #1D1D1F!important;
    border: 1px solid #1D1D1F!important;
    width: 56px; height: 56px; line-height: 58px; }
  /deep/ .upload-btn i.el-icon-plus { font-size: 26px;color:#fff!important; }
}
/* 2. -70 版 */
.upload-container.size70 {
  .upload-view .view-item { width:70px; height:70px; }
  /deep/ .upload-btn .el-upload.el-upload--picture-card { background-color: #1D1D1F!important;
    border: 1px solid #1D1D1F!important;width: 70px; height: 70px; line-height: 76px; }
  /deep/ .upload-btn i.el-icon-plus { font-size: 26px;color:#fff!important; }
}
...
.upload-container.size36 {
  .upload-view .view-item {
    ...
    i.el-icon-error { top: -10px; right: -17px; font-size: 20px; z-index: -1; }
    &:hover i.el-icon-error { top: 0; right: -17px; z-index: 1; }
  }
  /deep/ .upload-btn .el-upload.el-upload--picture-card { background-color: #1D1D1F!important;
    border: 1px solid #1D1D1F!important;width: 36px; height: 36px; line-height: 36px; }
