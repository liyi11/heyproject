<template>
  ...
  <div class="file-upload-container">
      <p  class="video_up_Box" v-if="String(filelist) == '' || limit != 1">
        <span v-if="typeval == 'video'" @click="btnClick">
          <span class="videoUp"><i class="el-icon-plus"></i></span>
          {{ fileLabel }}
        </span>
      ...
      <div class="video-box" v-if="!videoing" >
        ...
        <div class="video-item" v-for="(item, index) in filelist" :key="index" >
          <div class="video-data" v-if="typeval == 'video'">
            <video controls="controls" name="media" width="100%" height="201" >
...
.file-upload-container {
  ...
  .video-box {
    ...
    .video-item {
      ...
      margin-bottom: 10px;
      cursor: pointer;
      video {width: 100%;height: 201px;border-radius: 12px;}
