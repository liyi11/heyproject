      ...
      <section class="page_body" v-else>
        <section v-if="!editFlag">
          <section class="addBtn">
            <c-button>
              <span @click="openXM" class="main_button">添加用户</span>
            </c-button>
          </section>
          <c-content
            ...
            <el-table
              ...
              <el-table-column align="left" prop="name" label="用户名" :show-overflow-tooltip="true"/>
              <el-table-column align="left" prop="role_info.role_name" label="用户组" :show-overflow-tooltip="true"/>
              <el-table-column align="left" label="手机号" :show-overflow-tooltip="true">
                <template slot-scope="scope">
                  <span class="font_main">{{'+'+scope.row.phone_prefix + scope.row.phone_number}}</span>
                </template>
              </el-table-column>
              <el-table-column align="left" prop="email" label="邮箱" :show-overflow-tooltip="true"/>
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const {data,count} = await getUser(obj)
